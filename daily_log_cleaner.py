...
def clean_old_logs():
    ...
    scan_dirs = [
        os.path.join(base_dir, "python-agent", "swarm_logs"),
        base_dir # Root directory for swarm_master.log etc.
    ]
    ...
    # This prevents running out of space under high logging loads if rotation isn't configured on them
    master_logs = [
        os.path.join(base_dir, "swarm_master.log"),
        os.path.join(base_dir, "backend_errors.log")
    ]
