...
const BlogSection = ({ onBack, externalPosts = [], currentPath = "", setCurrentPath, onCareersClick, onBattleClick }) => {
  ...
  return (
    <div style={{ background: COLORS.bgLight, minHeight: "100vh", padding: "0", fontFamily: "'Outfit', sans-serif" }}>
      ...
      <Footer onBlogClick={() => {}} onLegalClick={setLegalModalType} onCareersClick={onCareersClick} onBattleClick={onBattleClick} />
